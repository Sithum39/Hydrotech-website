  ...
  return (
    ...
    sm:px-10 lg:px-10 xl:px-40'>
      ...
      max-lg:flex-col gap-10'>
        ...
        dark:text-gray-400'>
            {/* <img src={theme === 'dark' ?assets.logo_dark: assets.logo} className='w-32 sm:max-w-44' alt="" /> */}
            <p className='max-w-md'>From strategy to execution, we save and manage water resources </p>
        ...
        className='text-gray-600 dark:text-gray-400'>
            ...
            <p className='text-sm mt-2 mb-6'>The latest update for your billing system</p>
      ...
      <hr className='border-gray-300 dark:border-gray-600 my-6 '/>
        ...
        sm:justify-between gap-4 flex-wrap'>
            <p>All Rights Recieved @2025 HYDROTECH</p>
