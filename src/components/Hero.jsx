...
const Hero = () => {
    ...
    text-center w-full overflow-hidden text-gray-700'>
      ...
      className='inline-flex items-center gap-2 border
       border-gray-300 p-1.5 pr-4 rounded-full'>
        ...
        <p className='text-xs font-medium'>Trusted by Sri Lankan people</p>
      </motion.div>
  ...
  font-medium xl:leading-[95px] max-w-5xl'>Turning imagination into <span className='bg-gradient-to-r from-[#5044E5] to-[#4d8cea] 
  bg-clip-text text-transparent'>Digital</span> impact in water meters.</motion.h1>
...
We focus on transforming traditional water infrastructure into intelligent, connected systems that empower better decisions, reduce inefficiencies, and support long-term sustainability.
      ...
      className='relative'>
        <img src={assets.hero_img} alt="" className="w-full max-w-6xl rounded-4xl"/>
  <img src={assets.bgImage1} alt=""  className='absolute -top-40 -right-40 sm:top-0 sm:-right-16
   -z-10 dark:hidden'/>
      </motion.div>
    </div>
  )
