    ...
    gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
      ...
      max-w-2xl w-full'>
        ...
        <div className='sm:col-span-2'>
            ...
            <textarea name='message' rows={8} placeholder='Enter your message' className='w-full p-3
             text-sm outline-none rounded-lg border border-gray-300
        ...
        <div className='sm:col-span-2 flex justify-center'>
          ...
          hover:scale-103 transition-all'>Submit <img 
          src={assets.arrow_icon} alt=""  className='w-4'/></button>
        </div>
      </motion.form>
    </motion.div>
  )
